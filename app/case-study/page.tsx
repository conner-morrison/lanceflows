...
import { CASE_DATA } from "@/lib/cases-data";
    ...
    <>
      ...
      <main>
        ...
        <section className="section">
          <div className="wrap">
            <p className="why-note" style={{ margin: "0 auto 40px", maxWidth: 760 }}>
              Verified, enterprise-style project examples across product engineering, AI, cloud,
              data, and automation. Each one covers the business problem, our technical role, the
              solution delivered, the verified results, and the workflow impact. Click any card to
              read the full story.
            </p>

            <div className="case-card-grid" id="case-card-grid">
              {CASE_DATA.map((c, i) => {
                const num = String(i + 1).padStart(2, "0");
                const tag = c.category.split(" / ")[0];
                return (
                  <Link className="case-card" href={`/case-study/${c.id}`} key={c.id}>
